...
echo -e "[${blink}${yellow}*${tp}]$blue SQUEZY HackTool Programini Tercih Ettiginiz Için Teşekkürler...💛  {💤SQUEZY💤} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}👑Kurucu    $white":" $red SQUEZY$tp ${blink}${lightgreen}                       |$tp"
...
echo "  ~~~~~~~~~~~~~~~~~~~~~✨ SQUEZY & HackTool ✨~~~~~~~~~~~~~~~~~~~~~~~~~" 
        ...
        echo " [x] ✔ Exit" 
        echo ""
        echo -ne "❨${red}⭐SQUEZY⭐${tp}❩:(${blue}./SQUEZYHACKTOOL${tp})\n↳[${blink}${lightcyan}*${tp}]➢ " ; read option
        ...
        case "$option" in 
            ...
            x)
                ...
                cat banners/bcbanner
		echo -e "[${blink}${yellow}*${tp}]$red (Ctrl + C ) Tespit Edildi Cikiliyor..❌✨$tp"
                echo "[${blink}${yellow}*${tp}]$blue AY TEAM HackTool Programini Tercih Ettiginiz Için Teşekkürler...💛  {💤SQUEZY💤} :)$tp"
                echo ""
                exit 0
                ;;
        esac
