...
# variables
    ...
    #lc='/usr/local/bin/lolcat' # kali linux için
    setdir=$PWD
...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    echo ""
    echo -e "Default Kullanım İçin Dosyayı ${lightgreen}sudo bash ayteamhacktool.sh$tp"
    echo "------------------------------------------------------------------------------"
    echo -e $cyan"   📌KURUCU📌          $white":" $red 📌By SQUEZY#0001📌$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/SQUEZY0001$tp"
    echo -e $cyan"    Instagram           $white":" $red squezy_0000$tp"
    echo -e "$cyan    Discord            $white : $red https://discord.gg/mVpAz3xTvK$tp"
    echo -e "$cyan    canımsın>            $white : $red 💛AYTEAM💛 $tp"
    echo -e "$cyan    Developper         $white : $red 🐱‍👤SQUEZY🐱‍👤$tp"
    exit 0
...
echo -e "[${blink}${yellow}*${tp}]$blue AYTEAM HackTool Programini Tercih Ettiginiz Için Teşekkürler...💛  {💤SQUEZY💤} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}🥀KURUCU    $white":" $red By SQUEZY$tp${blink}${lightgreen}                    |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}✨Discord   $white":" $red https://discord.gg/mVpAz3xTvK$tp${blink}${lightgreen}|$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}📌Github    $white":" $red https://github.com/SQUEZY0001$tp${blink}${lightgreen}|$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}⭐Instagram $white":" $red squezy_0000$tp${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ------------------------------------------$tp\n"
echo " ~~~~~~~~~~~~~~~~~~~~~💥 AYTEAM & Termux 💥~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
        echo " [1] ✔ BluForce-FB" 
        ...
        echo " [h] ✔ Help" 
        echo " [q] ✔ Exit"  
        echo -ne "\n${red}┌─[${tp}${USER}${yellow}@${blue}🌙AY TEAM Hack Tool🌙${red}]─[${green}./darkhacktool-termux.sh${red}] \n└──╼${yellow}$ ${tp}" ; read option
        echo ""
        ...
        case "$option" in
            ...
            while :; do
                ...
                echo -e "b-) Ana Menü"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}DarkHackTool${red}]─[${green}./darkhacktool-termux.sh/PhoneInfoga${red}] \n└──╼${yellow}$ ${tp}" ; read input1
                if [[ $input1 = "1" ]] ; then
                echo -e "${green}[TR +${red}90${green}]${tp} +90 yazmadan ${blue}5312534783${tp} şeklinde giriniz"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}DarkHackTool${red}]─[${green}./darkhacktool-termux.sh/PhoneInfoga/TR${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
                ...
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}DarkHackTool${red}]─[${green}./darkhacktool-termux.sh/PhoneInfoga/custom${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
            ...
            q) 
                clear
                cat banners/bcbanner
                echo "[${blink}${yellow}*${tp}]$blue AYTEAM HackTool Programini Tercih Ettiginiz Için Teşekkürler...💛  {💤SQUEZY💤} :)$tp" 
                echo ""
                exit 0
                ;;
        esac
